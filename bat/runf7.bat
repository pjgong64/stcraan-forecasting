@echo off
rem ===========================================================================
rem  run_factorial7.bat
rem    run_factorial7.bat                  every family
rem    run_factorial7.bat STCRAAN          one family
rem    run_factorial7.bat LR RF XGB        several
rem  "auto" is added for you. Finished cells are skipped, so this is also how
rem  you resume after a stop.
rem ===========================================================================
setlocal
...
set "FAMS=%*"
if "%FAMS%"=="" set "FAMS=LR RF XGB MLP STCRAAN"
echo families: %FAMS%
